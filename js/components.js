  ...
  function renderSidebar(currentPage) {
    ...
    return '\
      ...
      <div class="sidebar-footer">\
        ' + syncIndicatorHtml + '\
        <div class="sidebar-nav-item" style="cursor: default; opacity: 0.9;">\
          ' + icons.user + '\
          <span class="sidebar-label">' + (FamilyOffice.Auth && FamilyOffice.Auth.isAuthenticated() ? FamilyOffice.Auth.getDisplayName() : 'Guest') + '</span>\
        </div>\
        <button id="logout-btn" class="sidebar-nav-item" style="width: 100%; border: none; background: transparent; text-align: left; cursor: pointer; color: var(--color-error); margin-top: 8px;">\
